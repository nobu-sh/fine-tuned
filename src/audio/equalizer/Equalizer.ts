...
import { EqualizerCoefficients } from './EqualizerCoefficients';
...
export class Equalizer extends EqualizerConfiguration {
  ...
  public createChannelProcessor(): ChannelProcessor[] {
    return Array.from({ length: this.channelCount }, () => new ChannelProcessor(this.bandMultipliers));
  }

  public process(input: ChannelProcessorInput[]): Buffer[] {
